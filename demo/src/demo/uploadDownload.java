...
public class uploadDownload {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		 ...
		 * //"C:\Users\885576\Documents\msedgedriver.exe" WebDriver driver = new
		 * EdgeDriver();
		 * driver.get("https://demo.automationtesting.in/FileUpload.html"); WebElement
		 * upload=driver.findElement(By.cssSelector("input[type='file']")); upload.
		 * sendKeys("C://Users//885576//Downloads//India- Holiday Calendar-2024.pdf/");
		 */

		// TODO Auto-generated method stub
		String fruitName = "Apple";
		String updatedValue = "603";
		String fileName = "C://Users//885576//Downloads//download.xlsx";
		...
		upload.sendKeys("C://Users//885576//Downloads//download.xlsx");
	...
	private static int getColumnNumber(String fileName, String colName) throws IOException { // TODO Auto-generated
		...
		ArrayList<String>();
																							 ...
																							 XSSFWorkbook
																								...
																								// the entire 1st row
		Iterator<Row> rows = sheet.iterator();// sheet is collection of rows 
		Row firstrow= rows.next(); Iterator<Cell>
